...
namespace LunarLander.Screens
{
    public class Options : GameScreen
    {
            ...
            KeyboardState keyState, InputHandler input)
        {
            ...
            if (input.KeyboardState.WasKeyPressed(Keys.Tab) ||             //Options to Main
                input.WasPressed(0, InputHandler.ButtonType.Y, Keys.Y))
            {
                screen.Pop();
            }

            if (input.KeyboardState.WasKeyPressed(Keys.Escape) ||       //Options to Exit
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            Vector2 v = spriteFont.MeasureString("Options") / new Vector2(2,2);

            spriteBatch.DrawString(spriteFont, "Options", (center - v), Color.White);
